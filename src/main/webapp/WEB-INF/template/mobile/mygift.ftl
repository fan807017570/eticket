...
<@htmlBody>
	...
	<div class="myTicket">
		<header class="public_header">
			<ul class="tabs half"> 
				<li><a href="${buyer_weixin_domain}/view/weixin/hongbao">收到的券</a></li>
				<li><a href="#" class="active">发出的券</a></li>
			</ul>
		</header>
		<div style="display: none;" class="notFound">
			<img src="${buyer_portal_static_resources_domain}/img/pic_crying2.png">
			<p>
				您还没有发出任何优惠券，赶紧<a href="${buyer_weixin_domain}/view/weixin/index">给好友发券</a>吧！
			</p>
		</div>
	...
	{{each shares as coupon}}
		<div class="item">
			...
			<div class="bottom">
				{{if coupon.receiver}}
					{{coupon.receivedDate}} {{coupon.receiver}} 收到您的红包
				{{else}}
					暂未被领取
				{{/if}}
			</div>
	...
	<script type="text/javascript">
		...
		function queryShared(curPage) {
			$(".fakeloader").show();
			loadmore = false;
			var loadDataUrl = "${buyer_weixin_domain}/view/share/shared?page="+curPage+"&ts="+new Date();
		...
		function doWxMethod() {
        	...
        	if(wx) {
        		...
        		wx.onMenuShareTimeline({
					title: '平安银行橙e券', // 分享标题
					link: '${buyer_weixin_domain}/view/weixin/mygift', // 分享链接
